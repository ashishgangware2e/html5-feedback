...
$(document).ready(function () {
  ...
  $(".toolWapper").html(
    '<div class="fromTarget"><div class="setMiddle"><div class="blockElments margin_bottom" id="countdownList"> </div><div class="blockElments" id="statmentText"></div></div></div><div class="clearAll"></div><div class="toTarget"><div class="clickableArea"></div><div class="bottomRightNegative">' +
      legentText[1] +
  ...
  function allcalculation(randomIndxPara, flagPara, endFlagPara) {
    ...
    $(".clickableArea").bind("click", function (e) {
      ...
      if (!endFlagPara == 0) {
        ...
        var lftpos = e.pageX - parseInt(offst.left - 1);
        ...
        if (
          ...
          $("#spot" + randomIndxPara[flagPara])
            .show()
            .attr("tooltip", statmentStr[flagPara])
            .css({ left: lftPrcnt - 1 + "%" });
        } else {
          $("#spot" + randomIndxPara[flagPara])
            .show()
        ...
        //if (statmentStr[flagPara]) {
        $("#movetext" + statmentStr[flagPara] + "").addClass("show");
        ...
        if ($(window).width() < 768) {
          $("#movetext" + randomIndxPara[flagPara]).animate(
            { left: offsetParentX - 400, top: offsetParentY - 10, opacity: 0 },
            500,
            function () {
              $(this).hide();
            }
