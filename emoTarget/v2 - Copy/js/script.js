	 ...
	 function countUpdate(count,totalCount){
		 ...
		 for(var i=0;i<totalCount;i++){
			...
			if(dragAttrImg !=""){
				...
				dvs += '<div class="stmnt" data-img='+dragAttrImg_[i]+' id="lbl'+randomIndx[i]+'" style="z-index:'+(zindx)+';">'+text+'</div>';
				zindx= zindx-1;
			}else{
				imgArr += '';
			
				dvs += '<div class="stmnt" id="lbl'+randomIndx[i]+'" style="z-index:'+(zindx)+';">'+text+'</div>';
				zindx= zindx-1;
			}
