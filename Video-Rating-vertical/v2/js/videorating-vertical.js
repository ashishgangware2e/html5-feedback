$(document).ready(function () {
  ...
  function widget() {
    ...
    <div class="video-rating-panel">\
        <video playsinline preload="auto" id="ratingVideo"  src=' +
        videoSource.split("|")[0] +
        ">\
  <source src=" +
        videoSource.split("|")[0] +
  ...
  <div class="panel sliderPanel">\
    ...
    $(".video-container").before(
      '<div class="title-toll">' +
        widget_title +
        '</div> <div class="loader-overlay"><div class="loader">Loading...</div></div><div class="errormsg">' +
        errorMsg +
        "</div>"
    );
    ...
    function func() {
      ...
      var height = parseInt($(".sliderPanel").css("height"));
      $(".video-container .panel").css({ height: h + "px" });
      $(".str-agree").css({ top: 0 + "%" });
      $(".agree").css({ top: 25 - 2 + "%" });
      $(".neither_agree").css({ top: 50 - 2 + "%" });
      $(".disagree").css({ top: 75 - 2 + "%" });
      $(".strongly_Disagree").css({ top: 100 + "%" });
      //};
    }
    // //func();
