  ...
  (function () {
    ...
    function u(a, b) {
      for (var c = E(), d = 0; d < 3; d++)
        for (var e = 0; e < 3; e++) {
          for (var f = 0, h = 0; h < 3; h++) f += a[d][h] * b[h][e];
          c[d][e] = f;
        }
      return c;
    }
    ...
    function R(a) {
      ...
      if (b.length != 4 || a.charAt(3) != "a") b[3] = 1;
      return b;
    }
    function F(a, b, c) {
    ...
    function H(a) {
      ...
      if (a.charAt(0) == "#") b = a;
        ...
        for (var d, e = 0; e < 3; e++) {
          d =
            c[e].indexOf("%") != -1
              ? Math.floor((parseFloat(c[e]) / 100) * 255)
              : +c[e];
          b += v[F(d, 0, 255)];
        }
        c = +c[3];
    ...
    function y(a, b, c) {
      if (
        ...
        a.m_ = b;
        if (c) a.lineScale_ = ca(da(b[0][0] * b[1][1] - b[0][1] * b[1][0]));
      }
    }
    function w(a) {
      this.type_ = a;
    ...
    function J(a, b) {
      ...
      if (a.readyState != "complete") throw new z("INVALID_STATE_ERR");
      switch (b) {
        case "repeat":
        case null:
        case "":
    ...
    g.drawImage = function (a) {
      ...
      } else m.push("top:", k(q.y / n), "px;left:", k(q.x / n), "px;");
      m.push(
        ' ">',
        '<g_vml_:image src="',
        a.src,
    ...
    g.stroke = function (a) {
      ...
      for (
        ...
        if (f) {
          if (c.x == null || f.x < c.x) c.x = f.x;
          if (d.x == null || f.x > d.x) d.x = f.x;
          if (c.y == null || f.y < c.y) c.y = f.y;
          if (d.y == null || f.y > d.y) d.y = f.y;
        }
      }
      b.push(' ">');
    ...
    g.drawText_ = function (a, b, c, d, e) {
      ...
      e ? T(this, o) : U(this, o, { x: -d, y: 0 }, { x: h, y: i.size });
      e =
        f[0][0].toFixed(3) +
        "," +
        f[1][0].toFixed(3) +
