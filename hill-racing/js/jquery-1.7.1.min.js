...
!(function (window, undefined) {
      ...
      return (
        ...
        jQuery.extend({
          ...
          parseXML: function (data) {
            ...
            try {
              window.DOMParser
                ? (xml = (tmp = new DOMParser()).parseFromString(
                    data,
                    "text/xml"
                  ))
          ...
          grep: function (elems, callback, inv) {
            ...
            for (var i = 0, length = elems.length; i < length; i++)
              inv !== (retVal = !!callback(elems[i], i)) && ret.push(elems[i]);
            return ret;
          },
  ...
  function createFlags(flags) {
    var object = (flagsCache[flags] = {}),
      i,
      length;
    for (i = 0, length = (flags = flags.split(/\s+/)).length; i < length; i++)
      object[flags[i]] = !0;
    return object;
  }
  jQuery.Callbacks = function (flags) {
    ...
    var list = [],
      ...
      self = {
        ...
        lock: function () {
          return (
            (stack = void 0), (memory && !0 !== memory) || self.disable(), this
          );
        },
        locked: function () {
          return !stack;
    ...
    (jQuery.support = (function () {
      ...
      if (
        ...
        window.getComputedStyle &&
          (((marginDiv = document.createElement("div")).style.width = "0"),
        ...
        jQuery(function () {
          ...
          body &&
            ...
            ((container = document.createElement("div")).style.cssText =
              vb + "width:0;height:0;position:static;top:0;margin-top:1px"),
            ...
            (jQuery.boxModel = support.boxModel = 2 === div.offsetWidth),
  ...
  jQuery.extend({
      ...
      data: function (key, value) {
        ...
        if (void 0 === key) {
          if (
            ...
            for (var i = 0, l = (attr = this[0].attributes).length; i < l; i++)
        ...
        return "object" == typeof key
          ...
          : (((parts = key.split("."))[1] = parts[1] ? "." + parts[1] : ""),
            void 0 === value
              ? (void 0 ===
    ...
    jQuery.extend({
      ...
      _unmark: function (force, elem, type) {
        if (
          (!0 !== force && ((type = elem), (elem = force), (force = !1)), elem)
        ) {
    ...
    jQuery.fn.extend({
      ...
      promise: function (type, object) {
        "string" != typeof type && ((object = type), (type = void 0)),
          (type = type || "fx");
        ...
        for (; i--; )
          (tmp =
            jQuery.data(elements[i], deferDataKey, void 0, !0) ||
            ((jQuery.data(elements[i], queueDataKey, void 0, !0) ||
              jQuery.data(elements[i], markDataKey, void 0, !0)) &&
              jQuery.data(
                elements[i],
                deferDataKey,
  ...
  jQuery.fn.extend({
    ...
    addClass: function (value) {
      ...
      if (value && "string" == typeof value)
        for (
          classNames = value.split(rspace), i = 0, l = this.length;
          i < l;
          i++
        )
    ...
    removeClass: function (value) {
      ...
      if ((value && "string" == typeof value) || void 0 === value)
        for (
          ...
          if (1 === (elem = this[i]).nodeType && elem.className)
            if (value) {
              for (
    ...
    jQuery.extend({
      ...
      attr: function (elem, name, value, pass) {
        ...
        if (elem && 3 !== nType && 8 !== nType && 2 !== nType)
          return pass && name in jQuery.attrFn
            ? jQuery(elem)[name](value)
            ...
            : ((notxml = 1 !== nType || !jQuery.isXMLDoc(elem)) &&
              ...
              void 0 !== value
                ...
                ? ret
                : null === (ret = elem.getAttribute(name))
                ? void 0
                : ret);
      },
      removeAttr: function (elem, value) {
        ...
        if (value && 1 === elem.nodeType)
          for (
            l = (attrNames = value.toLowerCase().split(rspace)).length;
            i < l;
            i++
          )
            (name = attrNames[i]) &&
              ...
              rboolean.test(name) && propName in elem && (elem[propName] = !1));
      },
      attrHooks: {
        type: {
          set: function (elem, value) {
    ...
    jQuery.support.style ||
      (jQuery.attrHooks.style = {
        get: function (elem) {
          return elem.style.cssText.toLowerCase() || void 0;
        },
        set: function (elem, value) {
  ...
  (jQuery.event = {
      ...
      if (
        ...
        for (
          handler.handler && (handler = (handleObjIn = handler).handler),
            ...
            (events = elemData.events) || (elemData.events = events = {}),
          ...
          (type = (tns = rtypenamespace.exec(types[t]) || [])[1]),
    ...
    remove: function (elem, types, handler, selector, mappedTypes) {
      ...
      if (elemData && (events = elemData.events)) {
        for (
          types = jQuery.trim(hoverHack(types || "")).split(" "), t = 0;
          t < types.length;
          t++
        )
          if (
            ((type = origType = (tns = rtypenamespace.exec(types[t]) || [])[1]),
            (namespaces = tns[2]),
            type)
          ) {
            for (
        ...
        jQuery.isEmptyObject(events) &&
          ((handle = elemData.handle) && (handle.elem = null),
          ...
          if (
            (((event =
              "object" == typeof event
                ...
                : new jQuery.Event(type)).type = type),
            (event.isTrigger = !0),
            ...
            if (
              ...
              (data = null != data ? jQuery.makeArray(data) : []).unshift(
                event
              ),
              !(special = jQuery.event.special[type] || {}).trigger ||
              ...
              return (
                ...
                onlyHandlers ||
                  ...
                  (ontype &&
                    ...
                    ((old = elem[ontype]) && (elem[ontype] = null),
    ...
    dispatch: function (event) {
      ...
      if (
        ...
        for (
          (jqcur = jQuery(this)).context = this.ownerDocument || this,
            cur = event.target;
          cur != this;
          cur = cur.parentNode || this
        ) {
          for (
            selMatch = {}, matches = [], jqcur[0] = cur, i = 0;
            i < delegateCount;
            i++
          )
            void 0 === selMatch[(sel = (handleObj = handlers[i]).selector)] &&
      ...
      for (
        ...
        for (
          matched = handlerQueue[i], event.currentTarget = matched.elem, j = 0;
              ...
              if (
                ...
                if (match)
                  for (i = 0; null != (item = curLoop[i]); i++)
                    item &&
                      ((pass = not ^ (found = filter(item, match, i, curLoop))),
                      inplace && null != found
                        ? pass
                          ? (anyFound = !0)
                          : (curLoop[i] = !1)
        ...
        Expr = (Sizzle.selectors = {
          ...
          preFilter: {
            CLASS: function (match, curLoop, inplace, result, not, isXML) {
              if (
                ((match = " " + match[1].replace(rBackslash, "") + " "), isXML)
              )
                return match;
          ...
          filters: {
            ...
            radio: function (elem) {
              return (
                "input" === elem.nodeName.toLowerCase() && "radio" === elem.type
              );
            },
            ...
            file: function (elem) {
              return (
                "input" === elem.nodeName.toLowerCase() && "file" === elem.type
              );
            },
            ...
            image: function (elem) {
              return (
                "input" === elem.nodeName.toLowerCase() && "image" === elem.type
              );
            },
            reset: function (elem) {
              var name = elem.nodeName.toLowerCase();
              return (
                ("input" === name || "button" === name) && "reset" === elem.type
              );
            },
          ...
          filter: {
            PSEUDO: function (elem, match, i, array) {
              ...
              if ("not" === name) {
                for (var not = match[3], j = 0, l = not.length; j < l; j++)
              ...
              switch (type) {
                ...
                case "nth":
                  ...
                  if (
                    ...
                    for (
                      count = 0, node = parent.firstChild;
                      node;
        ...
        for (var i = 0, l = checkSet.length; i < l; i++) {
          ...
          if (elem) {
            ...
            for (elem = elem[dir]; elem; ) {
              ...
              if (1 === elem.nodeType)
                if (
                  (isXML || ((elem[expando] = doneName), (elem.sizset = i)),
                  "string" != typeof cur)
                ) {
                  if (elem === cur) {
                    match = !0;
  ...
  jQuery.fn.extend({
    ...
    closest: function (selectors, context) {
      ...
      return (
        ...
        this.pushStack(ret, "closest", selectors)
      );
    },
    index: function (elem) {
      return elem
  ...
  function cloneFixAttributes(src, dest) {
    ...
    1 === dest.nodeType &&
      ...
      "object" === (nodeName = dest.nodeName.toLowerCase())
  ...
  function getAll(elem) {
    return void 0 !== elem.getElementsByTagName
      ? elem.getElementsByTagName("*")
      : void 0 !== elem.querySelectorAll
  ...
  function findInputs(elem) {
    ...
    "input" === nodeName
      ...
      : "script" !== nodeName &&
        void 0 !== elem.getElementsByTagName &&
            ...
            (first =
              ...
              (fragment = (results =
                ...
                parent.childNodes.length === this.length
                  ? { fragment: parent }
                  : jQuery.buildFragment(args, this, scripts)).fragment)
                .childNodes.length
          ...
          if (("number" == typeof elem && (elem += ""), elem)) {
            ...
            if (!jQuery.support.appendChecked)
              if (elem[0] && "number" == typeof (len = elem.length))
                for (j = 0; j < len; j++) findInputs(elem[j]);
        ...
        for (; i < len; i++)
          extra ||
            ...
            "margin" === extra
              ...
              : (val -=
                  parseFloat(jQuery.css(elem, "border" + which[i] + "Width")) ||
                  0);
      return val + "px";
    }
    if (
      (((val = curCSS(elem, name, name)) < 0 || null == val) &&
  ...
  (jQuery.fn.css = function (name, value) {
    return 2 === arguments.length && void 0 === value
      ? this
      : jQuery.access(this, name, value, !0, function (elem, name, value) {
          return void 0 !== value
    ...
    jQuery.extend({
      ...
      style: function (elem, name, value, extra) {
        if (elem && 3 !== elem.nodeType && 8 !== elem.nodeType && elem.style) {
          ...
          if (
            ((name = jQuery.cssProps[origName] || origName), void 0 === value)
          )
            return hooks &&
              "get" in hooks &&
          ...
          if (
            ...
            null == value ||
              ...
              hooks &&
                "set" in hooks &&
                void 0 === (value = hooks.set(elem, value))))
          )
            try {
              style[name] = value;
            } catch (e) {}
      ...
      css: function (elem, name, extra) {
        ...
        return (
          ...
          "cssFloat" === (name = jQuery.cssProps[name] || name) &&
            (name = "float"),
          hooks &&
          "get" in hooks &&
          void 0 !== (ret = hooks.get(elem, !0, extra))
            ? ret
            : curCSS
            ? curCSS(elem, name)
            : void 0
      ...
      swap: function (elem, options, callback) {
        ...
        for (name in (callback.call(elem), options))
  ...
  function inspectPrefiltersOrTransports(
    ...
    for (
      ...
      "string" ==
        typeof (selection = list[i](options, originalOptions, jqXHR)) &&
  ...
  function ajaxConvert(s, response) {
    ...
    for (i = 1; i < length; i++) {
      ...
      if (((prev = current), "*" === (current = dataTypes[i]))) current = prev;
        ...
        if (
          ...
          for (conv1 in ((conv2 = void 0), converters))
            if (
              ((tmp = conv1.split(" "))[0] === prev || "*" === tmp[0]) &&
              (conv2 = converters[tmp[1] + " " + current])
            ) {
              !0 === (conv1 = converters[conv1])
                ? (conv = conv2)
                : !0 === conv2 && (conv = conv1);
              break;
            }
  ...
  (ajaxLocParts = rurl.exec(ajaxLocation.toLowerCase()) || []),
    ...
    jQuery.extend({
      ...
      ajax: function (url, options) {
        ...
        var s = jQuery.ajaxSetup({}, options),
          ...
          jqXHR = {
            ...
            getResponseHeader: function (key) {
              ...
              return void 0 === match ? null : match;
            },
        ...
        if (
          ...
          (jqXHR.statusCode = function (map) {
            ...
            if (map)
              ...
              else (tmp = map[jqXHR.status]), jqXHR.then(tmp, tmp);
            return this;
          }),
          (s.url = ((url || s.url) + "")
            .replace(rhash, "")
        ...
        for (i in (((s.data && s.hasContent && !1 !== s.contentType) ||
          options.contentType) &&
      ...
      if (s.crossDomain) {
        ...
        return {
          send: function (_, callback) {
            ((script = document.createElement("script")).async = "async"),
        ...
        ("none" !== display && "" !== display) ||
          ...
          (iframeDoc && iframe.createElement) ||
            ((iframeDoc = (iframe.contentWindow || iframe.contentDocument)
              .document).write(
              ("CSS1Compat" === document.compatMode ? "<!doctype html>" : "") +
                "<html><body>"
            ),
            iframeDoc.close()),
      ...
      custom: function (from, to, unit) {
        ...
        (this.startTime = fxNow || createFxNow()),
          ...
          (t.saveState = function () {
            self.options.hide &&
              void 0 === jQuery._data(self.elem, "fxshow" + self.prop) &&
