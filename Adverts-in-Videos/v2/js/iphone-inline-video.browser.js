  ...
  function s(e) {
    ...
    r.video.readyState >= r.video.HAVE_FUTURE_DATA
      ? (r.hasAudio ||
          ...
          r.video.loop && u(r) && (r.driver.currentTime = 0)),
        o(r.video, r.driver.currentTime))
      : r.video.networkState !== r.video.NETWORK_IDLE ||
        r.video.buffered.length ||
        r.video.load(),
      r.video.ended && (delete r.video[b], r.video.pause(!0));
  }
  function c() {
    var e = this,
      r = e[h];
    return e.webkitDisplayingFullscreen
      ...
      : ("data:" !== r.driver.src &&
        ...
        void (
          ...
          r.hasAudio ||
            (d(e, "play"),
            r.video.readyState >= r.video.HAVE_ENOUGH_DATA && d(e, "playing")))
        ));
  }
  function v(e) {
    var r = this,
    ...
    n.driver.pause(),
      n.updater.stop(),
      r.webkitDisplayingFullscreen && r[T](),
      (n.paused && !e) ||
        ((n.paused = !0),
        n.hasAudio || d(r, "pause"),
        r.ended && ((r[b] = !0), d(r, "ended")));
  }
  function p(e, n) {
    var i = (e[h] = {});
    (i.paused = !0),
      ...
      e.addEventListener(
        ...
        function () {
          ...
          i.driver.src &&
            ...
            (o(e, 0, !0),
            (i.driver.src = e.src),
            r ? i.driver.play() : i.updater.stop());
        },
        !1
      ),
