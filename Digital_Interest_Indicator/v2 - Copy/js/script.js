$(document).ready(function() {
	...
	function init(dragAttrclr,defaultpos,totalTime){
		...
		var str = popup+'<div class="toolContaner">'+labeltxt+'</div><div class="toolContaner" style="padding-top:25px;"><div class="masklayer" id="masklayer"></div><div class="RatingSlider"></div></div><div class="toolContaner" style="padding-top:70px;">'+timeblock+'</div><div class="toolContaner">'+couontdown+'</div><div class="clearfix"></div>';
		$(".mainWaper").html(str);
		setboxShadow();
...
$(".ui-slider-pip-6 .ui-slider-label").css("background","#"+dragAttr[5]).html(" ");
$(".ui-slider-pip-7 .ui-slider-label").css("background","#"+dragAttr[6]).html(" ");
