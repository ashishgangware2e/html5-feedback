$(document).ready(function () {
  ...
  function init(dragAttrclr, defaultpos, totalTime) {
    ...
    var couontdown =
      '<div class="clockdiv"><span class="days" style="display:none;">00</span><span class="hours" style="display:none;">00</span><span id="min" class="minutes">00</span>:<span class="seconds" id="sec">00</span></div>';
    var timeblock =
      '<div class="TimeBlock" id="startBtn"><span>' +
      strt +
      '</span></div><div class="TimeBlock" id="stopBtn"><span>' +
      stp +
      "</span></div>";
    var labeltxt =
      '<div class="ratetextLeft">Not at all motivating</div><div class="ratetextRight">Extremely motivating</div>';
    var ratscle = '<div class="rateScal">&nbsp;</div>';
    var popup =
      '<div class="toolContaner timer-section">' +
      timeblock +
      '</div><div class="toolContaner clock-timer">' +
      couontdown +
      '</div><div class="popuplayer" id="popuplayer"><div class="popup"><p class="ppuptxt">' +
      popuptxt +
      '</p><div class="mainbbtn"><div class="confirm_btn" id="kbtn">OK</div><div class="confirm_btn" id="okbtn">Yes</div><div class="confirm_btn pading" id="cnlbtn">No</div></div></div></div>';
    var str =
      popup +
      '<div class="toolContaner rating-section" ><div class="ratetextLeft">' +
      optionText.split("|")[0] +
      '</div><div class="ratetextRight">' +
      optionText.split("|")[1] +
      '</div><div class="RatingSlider"></div><div class="masklayer" id="masklayer"></div></div>';
    $(".mainWaper").html(str);
    setboxShadow();
