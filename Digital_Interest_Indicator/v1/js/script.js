$(document).ready(function() {
	...
	function init(dragAttrclr,defaultpos,totalTime){
		...
		var timeblock = '<div class="start-stop"><div class="TimeBlock" id="startBtn"><span>'+strt+'</span></div><div class="TimeBlock" id="stopBtn"><span>'+stp+'</span></div></div><div class="complete-clock"><div class="timer-block"></div><div class="timer-div"><span class="days" style="display:none;">00</span><span class="hours" style="display:none;">00</span><span id="min" class="minutes">00</span>:<span class="seconds" id="sec">00</span></div></div>';
		...
		var str = popup+'<div class="toolContaner clearfix">'+timeblock+'</div><div class="toolContaner clearfix" style="padding-top:25px;"><div class="masklayer" id="masklayer"></div><div class="ratetextLeft">Not at all motivating</div><div class="ratetextRight">Extremely motivating</div><div class="RatingSlider"></div></div><div class="clearfix"></div>';
