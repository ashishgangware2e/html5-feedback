...
$("document").ready(function(){
	...
	for (var i=0; i<ArrStatementText.length; i++){
		...
		$("#binddata").append('<div class="slide-block"><div class="headlineTool">'+ArrStatementText[i]+'</div><div class="tbmid"><div id="slider-'+i+'" class="slider1" data-code="'+ArrstatementPrecode[i]+'"></div></div></div>');
		outoutArry[i]="";
	}
    ...
    var slider1 = $(".slider1").slider({
		...
		create: function() {
			...
			$('.slider1').each(function(){
				...
				$(this).find('.ui-slider-pip').each(function(key, value){
					$(this).find(".ui-slider-label").addClass('hilight_'+key).text(leftlebalValue[key]);
				});

			});
				
			//console.log( $(".ui-slider-pip").length );
	...
	/*$('.ui-slider-handle').click(function(){
		var nobCurrentVal=$(this).find("span").html();
		var nobCurrentId=$(this).parent().attr("id").split("-")[1];
		outoutArry[nobCurrentId]=nobCurrentVal;
		outputVal(outoutArry);
	});*/
	...
	/*$('.ui-slider-pip-selected').click(function(){
		var lablSCurrentVal=$(this).find('.ui-slider-label').attr("data-value");
		var lablSCurrentId=$(this).parent().attr("id").split("-")[1];
		outoutArry[lablSCurrentId] = lablSCurrentVal;
		outputVal(outoutArry);
