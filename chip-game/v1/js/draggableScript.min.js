      ...
      (arrayContainer["Arr" + t] = []),
        $(".droppbaleAre").append(
          "<div datd-info='" +
            ...
            "' id='drops" +
            t +
            "' class='drops marginRight shadowGray'><div class='drop-count'></div><div class='imgBlock'><img src='images/" +
            droppableAttr[t] +
            ...
            drop: function (r, t) {
              $(t.draggable).data("hasBeenDropped", !0),
                t.draggable.position({
                  ...
                  at: "center",
                  using: function (r) {
                    console.log("r", r.left + 1);
                    $(this).animate(r.left + 15, 300, "linear");
                    $(this).addClass("dragData");
                  },
                }),
