$(window).load(function () {
  ...
  function Output() {
    ...
    var subStr = str.substr(0, 2 * _length - 1);
...
function chipGameWidget() {
  $("body").append(
    '<div class="output-info"><b>Output</b>: Data export will show number of coins on each product</div>' +
      '<input type="hidden" id="resultstr" style="width: 100px" /><input type="hidden" id="resultstr1" style="width: 100px" />'
  );
}
