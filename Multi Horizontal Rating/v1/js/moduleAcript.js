        ...
        $(this).find(".ui-slider-handle")
          .append(
            "<div class='statmentText statmentArea" +
              ...
              "'><span class='text'>" +
              statementArr[indexI++] +
              "</span></span></div><span class='thd downBar" +[indexI] +
              "'></span>"
          );
          
        $(this).find(".ui-slider-range").css("background", barColorArr[indexI - 1]).addClass("cstm-range" + [indexI] + "");
        
        $(".bind-slider").find(".cstm-range"+ [indexI] + "").css({top:+(intialVal )+"px"});
