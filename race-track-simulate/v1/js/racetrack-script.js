        ...
        function createRaceTrack(imagesArr, trackTextArr, AarrscaleText) {
            ...
            $.each(imagesArr, function(i, v) {
                ...
                if (enableInput == 1) {
                    ...
                    _drgObj += "<div id=posi" + i + " class='dragThis' data-info='" + precode_[i] + "' style='left:" + 0 + "px; display:block; top:" + carTop + "%; z-index:" + indexZ + ";' title = " + arrText[i] + "><div class='showonDrp'>" + arrText[i] + "</div><div class='listDiv'><span>" + v + "</span></div><input class='labelText labletxt" + [i] + "' data-name=labletxt" + [i] + " value = " + arrText[i] + "  disabled></div>";
                    ...
                    if (i == 0) {
                        ...
                        _drgObj += "<div id=posi" + i + " class='dragThis disabled' data-info='" + precode_[i] + "' style='left:" + 0 + "px; display:block; top:" + carTop + "%; z-index:" + indexZ + ";'><div class='showonDrp'>" + arrText[i] + "</div><div class='listDiv'><span>" + v + "</span></div><input class='labelText labletxt" + [i] + "' data-name=labletxt" + [i] + " control-drag=posi" + i + "  maxlength='20' /></div>";
                    } else {
                       
                        _drgObj += "<div id=posi" + i + " class='dragThis disabled' data-info='" + precode_[i] + "' style='left:" + 0 + "px; display:block; top:" + carTop + "%; z-index:" + indexZ + ";'><div class='showonDrp'>" + arrText[i] + "</div><div class='listDiv'><span>" + v + "</span></div><input class='labelText labletxt" + [i] + "' data-name=labletxt" + [i] + " control-drag=posi" + i + "  maxlength='20' disabled/></div>";
                    }
                }
            ...
            // $(".warpermain").html('<div class="scaltextMainBlock-2 clearfix"><div class="scaltextMainBlock-2-inner"><div class="scaletextLef">' + AarrscaleText[0] + '</div><div class="scaletextRigh">' + AarrscaleText[1] + '</div></div></div><div class="carTrack clearfix"><div id="imgBlock" class="drg-blk"></div><div class="dropBlock"><div class="racetextLeft rotate" style="top:' + tps + 'px">' + IE81 + '</div><div class="dropHere"><div class="tracksImg"></div></div> <div class="racetextRight rotate" style="top:' + tps + 'px">' + IE82 + '</div>  <div class="scaltextMainBlock clearfix"><div class="scaleLIne"></div></div></div></div>');
             $(".warpermain").html('<div id="imgBlock" class="drg-blk"></div><div class="carTrack clearfix"><div class="dropBlock"><div class="dropHere"><div class="tracksImg"></div></div>  <div class="scaltextMainBlock clearfix"><div class="scaleLIne"></div><div class="drop-overlay"></div><div class="scaltextMainBlock-2 clearfix"><div class="scaltextMainBlock-2-inner"><div class="scaletextLef">' + AarrscaleText[0] + '</div><div class="scaletextRigh">' + AarrscaleText[1] + '</div></div></div></div></div>');
