  ...
  function widgetData() {
    ...
    $(".toolWapper").html(
      '<div class="target-row stmt-row clearfix"><div class="setMiddle"><div class="blockElments" id="statmentText"></div></div></div><div class="blockElments margin_bottom" id="countdownList"> </div><div class="target-row drp-zone clearfix"><div class="bottomRightNegative">' +
        legentText[1] +
        '</div><div class="toTarget y-axis"><div class="midset clearfix"><div class="clickableArea"><div class="bdr-clr"></div></div></div></div><div class="clearAll"></div><div class="BottomleftPosetive">' +
        legentText[0] +
        "</div></div>"
    );
    ...
    $(".clickableArea, .bdr-clr").bind("click", function (e) {
      ...
      if (!$(".borderBox").length == 0 && ends == true) {
        ...
        var output =
          Number(0) + Number(Math.round(((100 - 0) / dropedArea) * toppos));
        output = changeoutput(output);
        var topPrcntNew =
          Number(0) +
          Number(Math.round(((100 - 0) / dropedArea) * (toppos - 9)));
        ...
        $(".clickableArea").append(
          '<div class="knob" data-index="' +
            ...
            '" style="left:-12px;top:' +
            topPrcntNew +
            '%"><div class="strRotate"> <span class="current_text">' +
            currentStatementText +
            "</span></div></div>"
        );
        ...
        if (backpunch != true) {
          $(".borderBox:first").animate(
            { left: offsetParentX, top: offsetParentY, opacity: 0 },
            500,
            function () {
