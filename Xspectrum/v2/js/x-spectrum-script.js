$(document).ready(function () {
  ...
  function widgetData() {
    $(".toolWapper").html(
      '<div class="target-row"><div class="setMiddle"><div class="blockElments" id="statmentText"></div></div><div class="blockElments margin_bottom" id="countdownList"> </div></div><div class="target-row"> <div class="toTarget"><div class="midset"><div class="clickableArea"><div class="bdr-clr"></div></div></div><div class="bottomRightNegative">' +
        legentText[1] +
        '</div><div class="BottomleftPosetive">' +
        legentText[0] +
        '</div></div><div class="target-overlay"></div></div>'
    );

    $("#countdownList").html(
      '<div class="countBox"><span class="count-text">' +
        topCountStrArr[0] +
        "</span><span class='count-number'>0</span>" +
        "</div>"
    );
    ...
    $(".clickableArea, .bdr-clr").bind("click", function (e) {
      ...
      if (!$(".borderBox").length == 0 && ends == true) {
        ...
        var output =
          Number(0) + Number(Math.round(((100 - 0) / dropedArea) * lftpos));
        output = changeoutput(output);
        var lftPrcntNew =
          Number(0) +
          Number(Math.round(((100 - 0) / dropedArea) * (lftpos - 9)));
        ...
        if (backpunch != true) {
          ...
          $(".borderBox:first").animate(
            { left: offsetParentX - 650, top: offsetParentY - 10, opacity: 0 },
            500,
            function () {
              $(".borderBox:first").remove();
            }
