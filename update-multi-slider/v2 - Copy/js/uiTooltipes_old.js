...
$("document").ready(function(){
	...
	for (var i=0; i<ArrStatementText.length; i++){
		...
		$("#binddata tbody").append('<tr><td class="tbleft '+oddEven+'" style="font-family: '+fontFamily+'; color:'+fontColor+'; font-size:'+fontSize+'px">'+fnStatementtext[0]+'</td> <td class="tbmid"><div id="slider-'+initArr[i]+'" class="slider1"></div></td> <td class="tbright '+oddEven+'" style="font-family: '+fontFamily+'; color:'+fontColor+'; font-size:'+fontSize+'px">'+fnStatementtext[1]+'</td> </tr>');
		outoutArry[i]="";
	}
