...
for(var i=0; i<imgStr.length; i++){
	...
	$("#thumbnall").append('<div class="col-sm-3 col-lg-3 col-md-3 col-xs-6 thumbs mainCont">'
							...
							+'<div class="ttle">'+thumbtitle[i]+'</div>'
							+'<img id="thmbImg" class="img-responsive" src="'+imgStr[i]+'" alt="Short alt text">'
	...
	//else{
		...
		//$("#thumbnall").append('<div class="col-lg-2 col-md-4 col-xs-6 thumb" id="mainCont"><a class="thumbnail" href="#" data-image-id="" data-toggle="modal" data-title="" data-image="'+imgStr[i]+'" data-target="#image-gallery"><div class="dataText">'+imgStr[i].substr(0, limit-1)+'...</div> <div class="btn btn-primary bordrRadiusNone center-block">View large</div> </a> </div>');
...
$(function() {
	if(imgStr.length == 1){
		$(".mainCont > a").addClass("bordrs");
		outputValue(precodes)
	}
    $("a").on("click", function(e) {
		e.preventDefault();
		if(single_Sel=="true"){
			$(".mainCont > a").removeClass("bordrs");
