...
$('.archetypes').append(' <div class="row clearALL">\
<div class="col-lg-12 clearALL">\
  <div class="respondent-info">'+widgetTitle.split("|")[1]+'</div>\
</div>\
<div class="col-lg-12" id="thumbnall"></div>\
</div>\
<div class="col-lg-12 clearALL">\
<div class="output-info clearALL">\
  <b>Output</b>: '+widgetTitle.split("|")[2]+'\
</div>\
</div>');

$('.archetypes').before('<div class="title-toll">'+widgetTitle.split("|")[0]+'</div>');
