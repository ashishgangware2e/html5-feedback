...
(function (O, J) {
  ...
  J(G, "parts/Utilities.js", [G["parts/Globals.js"]], function (a) {
    ...
    a.pad = function (a, e, q) {
      return (
        Array((e || 2) + 1 - String(a).replace("-", "").length).join(q || "0") +
        a
      );
    };
    ...
    a.numberFormat = function (h, e, q, t) {
      ...
      -1 === e
        ...
        ? e &&
          ...
          ((n = e + +d[1]),
          0 <= n
            ? ((d[0] = (+d[0]).toExponential(n).split("e")[0]), (e = n))
            : ((d[0] = d[0].split(".")[0] || 0),
              (h = 20 > e ? (d[0] * Math.pow(10, d[1])).toFixed(e) : 0),
              (d[1] = 0)))
        : (e = 2);
      g = (
      ...
      init: function (h) {
        ...
        if (
          ...
          (h &&
            ...
            7 === e
              ? (q = [(h & 16711680) >> 16, (h & 65280) >> 8, h & 255, 1])
              : 4 === e &&
                (q = [
                  ((h & 3840) >> 4) | ((h & 3840) >> 8),
                  ((h & 240) >> 4) | (h & 240),
    ...
    b(E.prototype, {
          ...
          function () {
            ...
            p &&
              ...
              S[z]
                ? (w = S[z].attr("id"))
                : ((k.id = w = a.uniqueKey()),
                  (S[z] = L = r.createElement(p).attr(k).add(r.defs)),
                  (L.radAttr = g),
                  (L.stops = []),
      ...
      attr: function (y, f, b, c) {
        ...
        "string" === typeof y &&
          ...
          ((r = y), (y = {}), (y[r] = f));
        "string" === typeof y
          ? (p = (this[y + "Getter"] || this._defaultGetter).call(this, y, k))
          : (A(
              y,
              function (f, b) {
                d = !1;
                ...
                this.symbolName &&
                  -1 !== a.inArray(b, L) &&
                  (l || (this.symbolAttr(y), (l = !0)), (d = !0));
                !this.rotation ||
                  ("x" !== b && "y" !== b) ||
                  (this.doTransform = !0);
                d ||
                  ((g = this[b + "Setter"] || this._defaultSetter),
                  g.call(this, f, b, k),
                  !this.styledMode &&
                    this.shadows &&
          ...
          : k &&
            a.push(
              "rotate(" +
                ...
                " " +
                z(this.rotationOriginY, p.getAttribute("y") || 0) +
                ")"
            );
      ...
      align: function (a, f, b) {
        ...
        if (a) {
          if (
            ((this.alignOptions = a), (this.alignByTranslate = f), !b || F(b))
          )
          ...
          if (x || c.forExport) {
            try {
              (A =
                ...
                function (a) {
                  [].forEach.call(
                    k.querySelectorAll(".highcharts-text-outline"),
                    function (f) {
                      f.style.display = a;
                    }
                  );
      ...
      destroy: function () {
        ...
        l &&
          ...
          ([].forEach.call(
            ...
            function (a) {
              -1 < a.getAttribute("clip-path").indexOf(l.element.id) &&
        ...
        if (!a) this.destroyShadows();
          ...
          for (c = 1; c <= p; c++)
            (r = l.cloneNode(0)),
              ...
              b &&
                (e(r, "height", Math.max(e(r, "height") - k, 0)),
                (r.cutHeight = k)),
              f
                ? f.element.appendChild(r)
                : l.parentNode && l.parentNode.insertBefore(r, l),
              y.push(r);
          this.shadows = y;
        }
        return this;
    ...
    b(H.prototype, {
          ...
          n = function (k, p) {
            ...
            if (void 0 === x[p])
              if (f.getSubStringLength)
                ...
                y.getSpanWidth &&
                  (e(l(b || c, k)), (x[p] = r + y.getSpanWidth(a, f)));
            return x[p];
          },
          D,
          w;
        ...
        if (M !== a.textCache) {
          ...
          y || n || D || g || -1 !== r.indexOf(" ")
            ? (d && d.appendChild(f),
              ...
              r.forEach(function (r, y) {
                ...
                k.forEach(function (r) {
                  if ("" !== r || 1 === k.length) {
                    ...
                    if ((z = v(r, "style")))
                      (z = z.replace(/(;| |^)color([ :])/, "$1fill$2")),
                        e(n, "style", z);
                    (M = v(r, "href")) &&
                      !c &&
                      (e(n, "onclick", 'location.href\x3d"' + M + '"'),
                      e(n, "class", "highcharts-anchor"),
                      b.styledMode || u(n, { cursor: "pointer" }));
              ...
              D && p && a.attr("title", R(a.textStr, ["\x26lt;", "\x26gt;"])),
              d && d.removeChild(f),
      ...
      rect: function (a, f, b, c, r, k) {
        ...
        a = w(a)
          ...
          : void 0 === a
          ? {}
          : { x: a, y: f, width: Math.max(b, 0), height: Math.max(c, 0) };
        this.styledMode ||
      ...
      symbol: function (a, f, c, r, k, d) {
        var p = this,
          ...
          x =
            n(f) &&
            L &&
            L.call(this.symbols, Math.round(f), Math.round(c), r, k, d),
          e,
          D;
        L
          ? ((l = this.path(x)),
            ...
            ["width", "height"].forEach(function (a) {
              l[a + "Setter"] = function (a, f) {
                ...
                n(c) &&
                  ...
                  this.element && this.element.setAttribute(f, c),
                  this.alignByTranslate ||
                    ((b[r] = ((this[f] || 0) - c) / 2), this.attr(b)));
              };
            }),
            n(f) && l.attr({ x: f, y: c }),
            (l.isImg = !0),
      ...
      symbols: {
        ...
        arc: function (a, f, b, c, r) {
          var d = r.start,
            ...
            p = r.end - 0.001;
          b = r.innerR;
          c = z(r.open, 0.001 > Math.abs(r.end - r.start - 2 * Math.PI));
          var y = Math.cos(d),
            g = Math.sin(d),
            A = Math.cos(p),
            p = Math.sin(p),
        ...
        callout: function (a, f, b, c, r) {
          ...
          l && l > b
            ...
            : l && 0 > l
            ? r > f + k && r < f + c - k
              ? p.splice(33, 3, "L", a, r + 6, a - 6, r, a, r - 6, a, f + d)
              : p.splice(33, 3, "L", a, c / 2, l, r, a, c / 2, a, f + d)
            : r && r > c && l > a + k && l < a + b - k
            ? p.splice(
                23,
                3,
            ...
            : r &&
              ...
              l > a + k &&
              l < a + b - k &&
              p.splice(3, 3, "L", l - 6, f, l, f - 6, l + 6, f, b - d, f);
          return p;
        },
      },
      ...
      label: function (c, r, d, k, p, g, A, L, x) {
        ...
        U = function () {
          var a = D.element.style,
            f = {};
          z =
            (void 0 === C || void 0 === h || R) && n(D.textStr) && D.getBBox();
          ...
          u &&
            (w ||
              ((m.box = w = y.symbols[k] || q ? y.symbol(k) : y.rect()),
              w.addClass(
        ...
        m.xSetter = function (a) {
          m.x = a;
          N &&
            ((a -= N * ((C || z.width) + 2 * M)), (m["forceAnimate:x"] = !0));
          I = Math.round(a);
          m.attr("translateX", I);
        };
        ...
        if (this.added) {
          ...
          if ("SPAN" === d.tagName) {
            ...
            A !== this.cTT &&
              ...
              !h(C) ||
                (C === (this.oldRotation || 0) && e === this.oldAlign) ||
      ...
      getTimeTicks: function (a, q, v, n) {
        ...
        if (E(q)) {
          g.set(
            "Milliseconds",
            m,
            p >= e.second ? 0 : c * Math.floor(g.get("Milliseconds", m) / c)
          );
          p >= e.second &&
            g.set(
              "Seconds",
              m,
              p >= e.minute ? 0 : c * Math.floor(g.get("Seconds", m) / c)
            );
          p >= e.minute &&
            g.set(
              "Minutes",
              m,
              p >= e.hour ? 0 : c * Math.floor(g.get("Minutes", m) / c)
            );
          p >= e.hour &&
            g.set(
              "Hours",
              m,
              p >= e.day ? 0 : c * Math.floor(g.get("Hours", m) / c)
            );
          p >= e.day &&
            g.set(
              "Date",
              ...
              p >= e.month
                ? 1
                : Math.max(1, c * Math.floor(g.get("Date", m) / c))
            );
          p >= e.month &&
            (g.set(
              "Month",
              m,
              p >= e.year ? 0 : c * Math.floor(g.get("Month", m) / c)
            ),
            (k = g.get("FullYear", m)));
          p >= e.year && g.set("FullYear", m, k - (k % c));
          p === e.week &&
            ((k = g.get("Day", m)),
            g.set("Date", m, g.get("Date", m) - k + n + (k < n ? -7 : 0)));
          k = g.get("FullYear", m);
          n = g.get("Month", m);
          var K = g.get("Date", m),
            w = g.get("Hours", m);
              ...
              (q =
                p === e.year
                  ...
                  ? x && p === e.hour && 1 < c
                    ...
                    : q + p * c
                  : g.makeTime(k, n, K + m * c * (p === e.day ? 1 : 7))),
              m++;
          d.push(q);
          p <= e.hour &&
            1e4 > d.length &&
  ...
  J(G, "parts/Tick.js", [G["parts/Globals.js"]], function (a) {
    ...
    a.Tick.prototype = {
      addLabel: function () {
        ...
        n.isDatetimeAxis &&
          ...
          ((C = d.time.resolveDTLFormat(
            g.dateTimeLabelFormats[(!g.grid && c.higherRanks[k]) || c.unitName]
          )),
          (F = C.main));
        e.isFirst = x;
        e.isLast = h;
              ...
              if (
                (w.attr({
                  text: n.labelFormatter.call(
                    a.extend(e.formatCtx, { dateTimeLabelFormat: D[l] })
                  ),
                }),
                w.getBBox().width < n.getSlotWidth(e) - 2 * t(p.padding, 5))
              )
                return;
            w.attr({ text: "" });
          };
        if (H(w))
          ...
          if (
            (e.label = w =
              H(g) && p.enabled
                ? d.renderer.text(g, 0, 0, p.useHTML).add(n.labelGroup)
                : null)
          )
        ...
        l &&
          (this.shortenLabel
            ...
            : ((D.width = Math.floor(l)),
              (g.style || {}).textOverflow || (D.textOverflow = "ellipsis"),
              p.css(D)));
      },
      getPosition: function (e, n, g, d) {
        ...
        e = {
          x: e
            ? a.correctFloat(m.translate(n + g, null, null, d) + m.transB)
            : m.left +
              m.offset +
              (m.opposite
          ...
          y: e
            ...
            : a.correctFloat(k - m.translate(n + g, null, null, d) - m.transB),
        };
        ...
        H(C) ||
          (C =
            0 === c.side
              ...
              : 2 === c.side
              ? F.y + 8
              : Math.cos(g.rotation * u) * (F.y - g.getBBox(!1, 0).height / 2));
      ...
      renderGridLine: function (a, e, g) {
        ...
        b ||
          (d.chart.styledMode ||
            ((k.stroke = C), (k["stroke-width"] = h), m && (k.dashstyle = m)),
          c || (k.zIndex = 1),
          a && (e = 0),
          (this.gridLine = b =
            n
          ...
          n &&
            ((this.mark = x =
              b
                ...
                .add(d.axisGroup)),
            d.chart.styledMode || x.attr({ stroke: m, "stroke-width": h })),
          x[n ? "attr" : "animate"]({
    ...
    a.extend(I.prototype, {
      ...
      getPlotLinePath: function (a) {
        ...
        d(this, "getPlotLinePath", a, function (a) {
          ...
          p(g)
            ? f.horiz
              ? ((D = l), (w = z - f.bottom), (x = n = q(x, c, c + f.width)))
              : ((x = c), (n = h - f.right), (D = w = q(D, l, l + f.height)))
            : ((C = !0), (A = !1));
          a.path =
            C && !A
              ? null
              : b.renderer.crispLine(["M", x, D, "L", n, w], m || 1);
        });
        return a.path;
      },
        ...
        if (g && g / d < a.len / 3)
          if (a.isLog)
            this.paddedTicks.forEach(function (f, b, c) {
              b &&
                l.push.apply(l, a.getLogTickPositions(d, c[b - 1], c[b], !0));
            });
      ...
      adjustForMinRange: function () {
        ...
        c - b < this.minRange &&
          ...
          (d = (A - c + b) / 2),
          (d = [b - d, F(a.min, b - d)]),
          l && (d[2] = this.isLog ? this.log2lin(this.dataMin) : this.dataMin),
          (b = B(d)),
          (c = [b + A, F(a.max, b + A)]),
          l && (c[2] = this.isLog ? this.log2lin(this.dataMax) : this.dataMax),
          (c = h(c)),
          c - b < A && ((d[0] = c - A), (d[1] = F(a.min, c - A)), (b = B(d))));
        this.min = b;
        this.max = c;
      },
      getClosest: function () {
      ...
      setAxisTranslation: function (a) {
        ...
        if (D || m || p)
          (k = f.getClosest()),
            A
              ? ((g = A.minPointOffset), (e = A.pointRangePadding))
              : f.series.forEach(function (a) {
                  ...
                  p = Math.max(p, b);
                  if (!f.single || m)
                    (a = l.xrange && a instanceof l.xrange ? !D : D),
                      (g = Math.max(g, a && c(r) ? 0 : b / 2)),
      ...
      setTickInterval: function (f) {
        ...
        m
          ? ((c.linkedParent = l[c.coll][k.linkedTo]),
            ...
            k.type !== c.linkedParent.options.type && a.error(11, 1, l))
          : (!I &&
              u(C) &&
              (c.dataMin >= C
                ? ((n = C), (D = 0))
        ...
        !(h || c.axisPointRange || c.usePercentage || m) &&
          ...
          u(c.max) &&
          (l = c.max - c.min) &&
          (!u(v) && D && (c.min -= l * D), !u(B) && x && (c.max += l * x));
        p(k.softMin) &&
          !p(c.userMin) &&
          k.softMin < c.min &&
          (c.min = v = k.softMin);
        p(k.softMax) &&
          ...
          (c.max = B = k.softMax);
        p(k.floor) &&
          (c.min = Math.min(Math.max(c.min, k.floor), Number.MAX_VALUE));
        p(k.ceiling) &&
          (c.max = Math.max(
        ...
        I &&
          ...
          !u(v) && c.min < C && c.dataMin >= C
            ? (c.min = c.options.minRange ? Math.min(C, c.max - c.minRange) : C)
            : !u(B) &&
              c.max > C &&
              c.dataMax <= C &&
        ...
        c.tickInterval =
          c.min === c.max || void 0 === c.min || void 0 === c.max
            ? 1
            : m && !w && z === c.linkedParent.options.tickPixelInterval
      ...
      setAxisSize: function () {
        var f = this.chart,
          ...
          l = (this.width = Math.round(
            a.relativeLength(F(c.width, f.plotWidth - b[3] + b[1]), f.plotWidth)
          )),
      ...
      unsquish: function () {
        ...
        c
          ? (m =
              ...
              (u(p)
                ? [p]
                : l < F(a.autoRotationLimit, 80) && a.autoRotation)) &&
          ...
          for (w = "clip", A = d.length; !g && A--; )
            if (((C = d[A]), (C = l[C].label)))
              C.styles && "ellipsis" === C.styles.textOverflow
                ...
                : C.textPxLength > e && C.css({ width: e + "px" }),
                C.getBBox().height > this.len / d.length - (x.h - x.f) &&
          ...
          f &&
            ...
            a.shortenLabel
              ...
              : n &&
                !c &&
                "nowrap" !== p.whiteSpace &&
                (n < f.textPxLength || "SPAN" === f.element.tagName)
              ? ((b.width = n),
                D || (b.textOverflow = f.specificTextOverflow || w),
                f.css(b))
              : f.styles &&
                f.styles.width &&
                !b.width &&
      ...
      getOffset: function () {
        ...
        C &&
          ...
          x &&
            !1 !== C.reserveSpace &&
            ((a.titleOffset = D =
              a.axisTitle.getBBox()[g ? "height" : "width"]),
            (n = C.offset),
        ...
        if (c.hasData() || e)
          c.minorTickInterval &&
            ...
            g.length &&
              ...
              I &&
                (0 === c.min || c.single) &&
                (x[-1] || (x[-1] = new z(c, -1, null, !0)), x[-1].render(-1))),
            h &&
            ...
            this.chart.styledMode ||
              (p
                .attr({
                  stroke:
                    f.color ||
                    (l ? e("#ccd6eb").setOpacity(0.25).get() : "#cccccc"),
    ...
    E.prototype.getLogTickPositions = function (a, q, t, u) {
      ...
      if (0.5 <= a)
        ...
        (q = this.lin2log(q)),
          ...
          (a = B(a, null, H(a))),
          (g = this.getLinearTickPositions(a, q, t).map(this.log2lin)),
    ...
    function (a, E) {
      ...
      a.PlotLineOrBand.prototype = {
        render: function () {
          ...
          var e = this,
            ...
            f = x ? "bands" : "lines";
          n.isLog &&
            ((p = n.log2lin(p)), (k = n.log2lin(k)), (c = n.log2lin(c)));
          n.chart.styledMode ||
            (q
              ? ((C.stroke = l),
        ...
        renderLabel: function (a, e, g, d) {
          ...
          m ||
            ...
            (m.zIndex = d),
            (this.label = m = b.text(a.text, 0, 0, a.useHTML).attr(m).add()),
      ...
      a.extend(E.prototype, {
        getPlotBandPath: function (a, e) {
          ...
          if (d && g)
            for (
              a && ((p = d.toString() === g.toString()), (k = 0)), a = 0;
              a < d.length;
              a += 6
            )
              b && g[a + 1] === d[a + 1]
  ...
  J(G, "parts/Tooltip.js", [G["parts/Globals.js"]], function (a) {
    ...
    a.Tooltip.prototype = {
      init: function (a, e) {
        ...
        this.outside =
          q(e.outside, !(!a.scrollablePixelsX && !a.scrollablePixelsY)) &&
          !this.split;
      },
      ...
      getPosition: function (a, e, d) {
        var g = this.chart,
          ...
          z = function (a, c, f, l) {
            ...
            l < b || l > c - b
              ? (d = !1)
              : (k[a] = l < f / 2 ? 1 : l > c - f / 2 ? c - f - 2 : l - f / 2);
            return d;
          },
          I = function (a) {
            var b = C;
      ...
      refresh: function (e, g) {
        ...
        m.enabled &&
          (a.clearTimeout(this.hideTimer),
          (this.followPointer = t(k)[0].series.tooltipOptions.followPointer),
              ...
              this.split
                ...
                : ((m.style.width && !w) ||
                  ...
                  d
                    ...
                    .addClass(
                      "highcharts-color-" + q(k.colorIndex, c.colorIndex)
                    ),
                  w ||
                    d.attr({
              ...
              (e.tt = A =
                k
                  .label(
                    ...
                    null,
                    null,
                    (l.isHeader ? c.headerShape : c.shape) || "callout",
                    null,
                    null,
                    c.useHTML
                  )
              ...
              ? ((x = a.height),
                ...
                (z = Math.max(
                  ...
                  Math.min(
                    ...
                    b.chartWidth +
                      (b.scrollablePixelsX
                        ? b.scrollablePixelsX - b.marginRight
                        : 0) -
                      z
                  )
                )))
              : (z = l.plotX + b.plotLeft - q(c.distance, 16) - z);
            0 > z && (p = !1);
            a =
      ...
      getDateFormat: function (a, e, d, m) {
        ...
        for (c in v) {
          ...
          if (g[c] && k.substr(g[c]) !== "01-01 00:00:00.000".substr(g[c]))
            break;
          "week" !== c && (h = c);
        }
      ...
      getXDateFormat: function (a, e, d) {
        ...
        return (
          (g ? this.getDateFormat(g, a.x, d.options.startOfWeek, e) : e.day) ||
          e.year
        );
      },
    ...
    a.Pointer.prototype = {
      ...
      runPointActions: function (b, c) {
        ...
        if (p && (p !== d.hoverPoint || (k && k.isHidden))) {
          ...
          d.series.forEach(function (a) {
            (a.options.inactiveOtherPoints || -1 === l.indexOf(a)) &&
              a.setState("inactive", !0);
          });
          (D || []).forEach(function (a) {
            a.setState("hover");
  ...
  J(G, "parts/TouchPointer.js", [G["parts/Globals.js"]], function (a) {
    ...
    H(a.Pointer.prototype, {
      ...
      pinchTranslateDirection: function (a, h, t, u, v, n, g, d) {
        ...
        r
          ? ((z -= 0.8 * (z - g[b][0])), D || (f -= 0.8 * (f - g[b][1])), t())
          : (g[b] = [z, f]);
        C || ((n[b] = w - x), (n[c] = q));
        n = C ? 1 / F : F;
        v[c] = q;
      ...
      pinch: function (a) {
        ...
        "touchstart" === a.type
          ...
          : u.length &&
            (m ||
              (e.selectionMarker = m = H({ destroy: B, touch: !0 }, t.plotBox)),
    ...
    a.Legend.prototype = {
      ...
      colorizeItem: function (a, d) {
        ...
        if (!this.chart.styledMode) {
          ...
          g &&
            (n &&
              g.isMarker &&
              ((l = a.pointAttribs()), d || (l.stroke = l.fill = m)),
            g.attr(l));
        }
          ...
          this.allItems.forEach(function (b) {
            ...
            k &&
              ...
              H(k, {
                ...
                top: g + "px",
                display:
                  this.proximate || (g > d - 6 && g < d + e - 6) ? "" : "none",
              }));
          }, this));
      },
      ...
      renderItem: function (a) {
        ...
        D ||
          ...
          (a.legendItem = D =
            d.text("", l ? e + g : -g, this.baseline || 0, f)),
          b.styledMode || D.css(u(a.visible ? m : h)),
          D.attr({ align: l ? "left" : "right", zIndex: 2 }).add(a.legendGroup),
          this.baseline ||
      ...
      layoutItem: function (a) {
        ...
        c &&
          this.itemX - d + b > n &&
          ((this.itemX = d),
          this.lastLineHeight && (this.itemY += m + this.lastLineHeight + g),
        ...
        e &&
          [
            ...
            g.test(e) &&
              ...
              (b[t[m]] = Math.max(
                b[t[m]],
                b.legend[(m + 1) % 2 ? "legendHeight" : "legendWidth"] +
                  [1, -1, -1, 1][m] * c[m % 2 ? "x" : "y"] +
                  v(c.margin, 12) +
                  d[m] +
      ...
      proximatePositions: function () {
        ...
        this.allItems.forEach(function (c) {
          ...
          c.yAxis &&
            ...
            c.visible
              ? ((k = k ? k.plotY : c.yAxis.height), (k += m - 0.3 * g))
              : (k = m + c.yAxis.height),
      ...
      handleOverflow: function (a) {
        ...
        f.length = 0;
        a > g && !1 !== D.enabled
          ? ((this.clipHeight = n = Math.max(g - 20 - this.titleHeight - m, 0)),
            ...
            t(n),
            I ||
              ((this.nav = I = c.g().attr({ zIndex: 1 }).add(this.group)),
              ...
              this.pager.add(I),
              (this.down = c.symbol("triangle-down", 0, 0, z, z).add(I)),
      ...
      scroll: function (a, d) {
        ...
        0 < e &&
          ...
          this.chart.styledMode ||
            (this.up.attr({ fill: 1 === e ? k.inactiveColor : k.activeColor }),
            this.upTracker.css({ cursor: 1 === e ? "default" : "pointer" }),
            this.down.attr({ fill: e === c ? k.inactiveColor : k.activeColor }),
        ...
        f.forEach(function (a) {
          a.isDirty &&
            ("point" === a.options.legendType
              ...
              : e && (e.labelFormatter || e.labelFormat) && (g = !0));
      ...
      layOutTitles: function (a) {
        ...
        ["title", "subtitle"].forEach(function (a) {
          ...
          c &&
            ...
            c
              .css({ width: (l.width || d.width + l.widthAdjust) + "px" })
      ...
      drawChartBox: function () {
        ...
        m ||
          ...
          h &&
            (A
              ? A.animate(C)
              : (this.plotBGImage = b.image(h, z, n, x, w).add())));
        I
      ...
      linkSeries: function () {
        ...
        b.forEach(function (b) {
          ...
          x(c) &&
            ...
            (b.linkedParent = c),
            (b.visible = D(b.options.visible, c.options.visible, b.visible)));
        });
  ...
  J(G, "parts/ScrollablePlotArea.js", [G["parts/Globals.js"]], function (a) {
    ...
    E(H, "afterSetChartSize", function (B) {
      ...
      if (!this.renderer.forExport) {
        if (e) {
          ...
          h &&
            (this.scrollablePixelsY = e = Math.max(0, h - this.chartHeight)) &&
            ((this.plotHeight += e),
            this.inverted
              ? (this.clipBox.width += e)
              : (this.clipBox.height += e),
    ...
    H.prototype.moveFixedElements = function () {
      var a = this.container,
        ...
        e =
          ".highcharts-contextbutton .highcharts-credits .highcharts-legend .highcharts-reset-zoom .highcharts-subtitle .highcharts-title .highcharts-legend-checkbox".split(
            " "
          ),
        q;
      ...
      e.forEach(function (e) {
        [].forEach.call(a.querySelectorAll(e), function (a) {
          (a.namespaceURI === h.SVG_NS ? h.box : h.box.parentNode).appendChild(
            a
          );
      ...
      e
        ? ((this.fixedDiv = a.createElement(
          ...
          (this.fixedRenderer = B =
            new a.Renderer(this.fixedDiv, this.chartWidth, this.chartHeight)),
      ...
      optionsToObject: function (d) {
        ...
        if (t(d) || null === d) e[p[0]] = d;
          ...
          for (
            ...
            (g && void 0 === d[h]) ||
              (0 < p[n].indexOf(".")
                ? a.Point.prototype.setNestedProperty(e, d[h], p[n])
                : (e[p[n]] = d[h])),
              h++,
              n++;
        else
      ...
      },
      {
            ...
            (b.axisTypes || []).forEach(function (l) {
              d[l].forEach(function (a) {
                ...
                if (
                  ...
                  b.insert(a.series), (b[l] = a), (a.isDirty = !0);
              });
          ...
          if (!K) {
            ...
            if (w && A > w) {
              ...
              for (k = 0; k < A; k++)
                void 0 !== e[k] &&
                  ((z = { series: l }),
                  l.pointClass.prototype.applyOptions.apply(z, [e[k]]),
        ...
        processData: function (b) {
          ...
          var h = this.getExtremesFromAll || p.getExtremesFromAll,
            ...
            C,
            q;
          if (n && !this.isDirty && !k.isDirty && !this.yAxis.isDirty && !b)
            return !1;
          ...
          n &&
            ...
            (c[e - 1] < C || c[0] > q
              ...
              : this.yData &&
                (c[0] < C || c[e - 1] > q) &&
                ((l = this.cropData(this.xData, this.yData, C, q)),
                (c = l.xData),
                (d = l.yData),
                (l = l.start),
                (f = !0)));
          for (m = c.length || 1; --m; )
            (e = x ? p(c[m]) - p(c[m - 1]) : c[m] - c[m - 1]),
              0 < e && (void 0 === g || e < g)
                ? (g = e)
                : 0 > e && w && (a.error(15, !1, this.chart), (w = !1));
          this.cropped = f;
          this.cropStart = l;
        ...
        generatePoints: function () {
          ...
          for (q = 0; q < m; q++)
            (h = p + q),
              x
                ? ((w = new k().init(this, [e[q]].concat(K(f[q])))),
          ...
          for (w = 0; w < r; w++) {
            ...
            var V = G.low,
              O =
                b &&
                h.stacks[
                  (this.negStacks && v < (t ? 0 : x) ? "-" : "") + this.stackKey
                ],
              W,
              X;
            ...
            G.plotX = F = e(
              Math.min(
                Math.max(
                  -1e5,
                  k.translate(J, 0, 0, 0, 1, q, "flags" === this.type)
                ),
                1e5
              )
            );
            ...
            d(X) &&
              ((V = X[0]),
              (v = X[1]),
              V === t && B.key === O[J].base && (V = c(m(x) && x, h.min)),
            ...
            G.yBottom = u(V)
              ? Math.min(Math.max(-1e5, h.translate(V, 0, 1, 0, 1)), 1e5)
              : null;
        ...
        setClip: function (a) {
          ...
          k ||
            (a &&
              ((l.width = 0),
              e && (l.x = b.plotSizeX + (!1 !== c.clip ? 0 : b.plotTop)),
              (b[g + "m"] = m =
                d.clipRect(
                  e ? b.plotSizeX + 99 : -99,
        ...
        drawPoints: function () {
          ...
          var q,
            x = c(
              m.enabled,
              !d || d.isRadial ? !0 : null,
              this.closestPointRangePx >= m.enabledThreshold * m.radius
            );
              ...
              if (
                ...
                f
                  ...
                  : n &&
                    ...
                    (e.graphic = f =
                      b.renderer
                        .symbol(g, q.x, q.y, q.width, q.height, h ? p : m)
                        .add(w));
                if (f && !b.styledMode)
                  f[k](this.pointAttribs(e, e.selected && "select"));
        ...
        drawGraph: function () {
          ...
          e.forEach(function (f, e) {
            var l = f[0],
              ...
              k = g ? "animate" : "attr";
            g
              ? ((g.endX = a.preventGraphAnimation ? null : c.xMap),
                g.animate({ d: c }))
              : c.length &&
                (a[l] = g =
                  a.chart.renderer
          ...
          e.length && (p || h) && w && void 0 !== w.min
            ? ((x = w.reversed),
              ...
              e.forEach(function (e, l) {
                ...
                f = Math.min(
                  Math.max(
                    Math.round(w.toPixels(c(e.value, q.max), !0) || 0),
                    0
                  ),
                  n
                );
                ...
                F = Math.max(g, f);
                w.isXAxis
                  ? ((m = { x: C ? F : v, y: 0, width: u, height: n }),
                    t || (m.x = b.plotHeight - m.x))
                  : ((m = { x: 0, y: C ? F : v, width: n, height: u }),
      ...
      if (
        ...
        for (f = 0; f < m; f++)
          (r = e[f]),
            ...
            (z = C[z][r]),
            null !== E
              ? ((z.points[I] = z.points[this.index] = [u(z.cumulative, p)]),
                h(z.cumulative) || (z.base = I),
                (z.touched = v.stacksTouched),
                0 < D.index &&
                  !1 === this.singleStacks &&
                  (z.points[I][0] = z.points[this.index + "," + r + ",0"][0]))
  ...
  J(G, "parts/Dynamics.js", [G["parts/Globals.js"]], function (a) {
    ...
    v(h.prototype, {
      ...
      update: function (c, d, e, m) {
        ...
        this.collectionsWithUpdate.forEach(function (a) {
          ...
          c[a] &&
            ...
            F(c[a]).forEach(function (c, d) {
              (d = (t(c.id) && l.get(c.id)) || l[a][b ? b[d] : d]) &&
                d.coll === a &&
              ...
              !d &&
                ...
                (l.collectionsWithInit[a][0].apply(
                  l,
                  [c].concat(l.collectionsWithInit[a][1] || []).concat([!1])
                ).touched = !0);
            }),
            e &&
        ...
        q || (g(r) && r !== l.chartWidth) || (g(f) && f !== l.chartHeight)
          ? l.setSize(r, f, m)
          : p(d, !0) && l.redraw(m);
    ...
    v(c.prototype, {
      update: function (a, b, c, e) {
        function g() {
          ...
          n.data[m] =
            d(n.data[m], !0) || d(a, !0) ? l.options : p(a, n.data[m]);
        ...
        getGraphPath: function (e) {
          ...
          for (n = 0; n < e.length; n++)
            if (
              ...
              t || w(n, n - 1, "left"),
                (g && !u && t) ||
                  (m.push(e[n]), d.push({ x: n, plotX: k, plotY: K })),
                t || w(n, n + 1, "right");
          n = h.call(this, m, !0, !0);
          d.reversed = !0;
          g = h.call(this, d, !0, !0);
        ...
        drawGraph: function () {
          ...
          u.forEach(function (e) {
            ...
            g
              ...
              : ((m.zIndex = 0),
                (g = a[n] =
                  a.chart.renderer.path(h).addClass(e[1]).add(a.group)),
                (g.isArea = !0));
            a.chart.styledMode ||
              (m.fill = H(
                e[3],
        ...
        getPointSpline: function (a, B, h) {
          ...
          if (
            ...
            v > a && v > q
              ...
              : v < a && v < q && ((v = Math.min(a, q)), (g = 2 * q - v));
            g > h && g > q
              ? ((g = Math.max(h, q)), (v = 2 * q - g))
              : g < h && g < q && ((g = Math.min(h, q)), (v = 2 * q - g));
            B.rightContX = n;
            B.rightContY = g;
          }
          B = [
      ...
      },
      {
        ...
        translate: function () {
          ...
          a.points.forEach(function (b) {
            ...
            n &&
              Math.abs(A) < n &&
              ((A = n),
              (u = (!k.reversed && !b.negative) || (k.reversed && b.negative)),
              b.y === p && a.dataMax <= p && k.min < p && l !== D && (u = !u),
              (x = Math.abs(x - c) > n ? e - n : c - (u ? n : 0)));
            ...
            b.tooltipPos = d.inverted
              ? [k.len + k.pos - d.plotLeft - g, a.xAxis.len - m - q / 2, A]
        ...
        pointAttribs: function (a, d) {
          ...
          d &&
            ...
            (c =
              a.color ||
              (void 0 !== d && H(c).brighten(a.brightness).get()) ||
              c),
            (h = a[b] || h),
            (n = a[g] || n),
            (k = a.dashStyle || k),
        ...
        drawPoints: function () {
          ...
          a.points.forEach(function (c) {
            ...
            if (e(c.plotY) && null !== c.y) {
              ...
              d.styledMode ||
                g[p](a.pointAttribs(c, c.selected && "select")).shadow(
      ...
      },
      {
        ...
        getX: function (a, e, b) {
          ...
          return (
            ...
            (e ? -1 : 1) *
              Math.cos(
                Math.asin(
                  Math.max(Math.min((a - d[1]) / (g + b.labelDistance), 1), -1)
                )
              ) *
              (g + b.labelDistance) +
            (0 < b.labelDistance
        ...
        translate: function (d) {
          ...
          for (A = 0; A < z; A++) {
            ...
            B.labelPosition = {
              ...
              final: {},
              alignment:
                0 > B.labelDistance ? "center" : B.half ? "right" : "left",
              connectorPosition: {
                breakAt: {
        ...
        redrawPoints: function () {
          ...
          !q ||
            a.shadowGroup ||
            g.styledMode ||
            (a.shadowGroup = b.g("shadow").attr({ zIndex: -1 }).add(a.group));
          a.points.forEach(function (d) {
            ...
            if (!d.isNull && h) {
              ...
              if (!g.styledMode) {
                ...
                q &&
                  !p &&
                  (p = d.shadowGroup = b.g("shadow").add(a.shadowGroup));
                p && p.attr(k);
                c = a.pointAttribs(d, d.selected && "select");
              }
              d.delayedRendering
                ? (h.setRadialReference(a.center).attr(n).attr(k),
                  g.styledMode ||
                    h.attr(c).attr({ "stroke-linejoin": "round" }).shadow(q, p),
  ...
  J(G, "parts/DataLabels.js", [G["parts/Globals.js"]], function (a) {
          ...
          w.forEach(function (d) {
            ...
            u.forEach(function (e, f) {
              ...
              g &&
                ...
                (q = e.rotation),
                c.styledMode ||
                  ((m.color = t(e.color, m.color, p.color, "#000000")),
                  "contrast" === m.color &&
                    ((d.contrastColor = B.getContrast(d.color || p.color)),
                    (m.color =
                      e.inside ||
              ...
              !r || (g && H(k))
                ? g &&
                  ...
                  e.textPath &&
                    !e.useHTML &&
                    r.setTextPath(
                      (d.getDataLabelPath && d.getDataLabelPath(r)) ||
                        d.graphic,
                      e.textPath
                    ),
      ...
      var b = this.chart,
        ...
        u =
          ...
          (a.series.forceDL ||
            ...
            (c && b.isInsidePlot(h, k ? c.x + 1 : c.y + c.height - 1, k))),
        ...
        n
          ? ((f = !1),
            ...
            "left" === q
              ...
              : "right" === q && ((h.x -= l.width), (h.y -= m ? 0 : l.height)),
            (d.placed = !0),
            (d.alignAttr = h))
          : (d.align(e, null, c), (h = d.alignAttr)),
        f && 0 <= c.height
          ? (a.isLabelJustified = this.justifyDataLabel(d, e, h, l, c, g))
          : t(e.crop, !0) &&
            (u =
    ...
    v.prototype.justifyDataLabel = function (a, d, e, c, g, h) {
      ...
      l = e.y + n;
      0 > l &&
        ("bottom" === m ? (d.verticalAlign = "top") : (d.y = -l), (p = !0));
      l = e.y + c.height - n;
      l > b.plotHeight &&
        ("top" === m ? (d.verticalAlign = "bottom") : (d.y = b.plotHeight - l),
        (p = !0));
              ...
              for (
                b.sortByAngle(d, e - 0.5),
                  0 < b.maxLabelDistance &&
                    ...
                    (p = Math.min(f + B + b.maxLabelDistance, c.plotHeight)),
                    d.forEach(function (a) {
                      0 < a.labelDistance &&
                        a.dataLabel &&
                        ((a.top = Math.max(0, f - B - a.labelDistance)),
                        (a.bottom = Math.min(
                          f + B + a.labelDistance,
                          c.plotHeight
                        )),
                ...
                r._pos = {
                  x: J + h.x + ({ left: m, right: -m }[N.alignment] || 0),
                  y: y + h.y - 10,
                };
                N.final.x = J;
                N.final.y = y;
                t(h.crop, !0) &&
                  ...
                  (k = null),
                  J - G < m && 1 === e
                    ? ((k = Math.round(G - J + m)), (P[3] = Math.max(k, P[3])))
                    : J + G > q - m &&
                      0 === e &&
                      ((k = Math.round(J + G - q + m)),
                      (P[1] = Math.max(k, P[1]))),
                  0 > y - L / 2
                    ? (P[0] = Math.max(Math.round(-y + L / 2), P[0]))
                    : y + L / 2 > u &&
                      (P[2] = Math.max(Math.round(y + L / 2 - u), P[2])),
                  (r.sideOverflow = k));
              }
          }),
        ...
        h ||
          (null !== c[0]
            ...
            : ((g = Math.max(b[2] - a[1] - a[3], e)),
              (b[0] += (a[3] - a[1]) / 2)),
          null !== c[1]
            ? (g = Math.max(Math.min(g, b[2] - Math.max(a[0], a[2])), e))
  ...
  J(G, "parts/Interaction.js", [G["parts/Globals.js"]], function (a) {
    ...
    J = a.TrackerMixin = {
      ...
      drawTrackerGraph: function () {
        ...
        if (e && !c)
          for (n = e + 1; n--; )
            "M" === d[n] && d.splice(n + 1, 0, d[n + 1] - f, d[n + 2], "L"),
              ((n && "M" === d[n]) || n === e) &&
      ...
      setItemEvents: function (a, b, c) {
        ...
        (c ? b : a.legendGroup)
          ...
          .on("mouseout", function () {
            d.styledMode ||
              b.css(m(a.visible ? d.itemStyle : d.itemHiddenStyle));
            d.allItems.forEach(function (b) {
              a !== b && b.setState("", !g);
            });
            e.removeClass(h);
      ...
      zoom: function (c) {
        ...
        !c || c.resetSelection
          ...
          : c.xAxis.concat(c.yAxis).forEach(function (b) {
              ...
              g[n ? "zoomX" : "zoomY"] &&
                p &&
                ((e = c.zoom(b.min, b.max)), c.displayBtn && (k = !0));
            });
        m = d.resetZoomButton;
        k && !m
          ? d.showResetZoom()
        ...
        e &&
          d.redraw(
            b(d.options.chart.animation, c && c.animation, 100 > d.pointCount)
          );
      },
      pan: function (a, b) {
        var c = this,
        ...
        u(this, "pan", { originalEvent: a }, function () {
          ...
          ("xy" === b ? [1, 0] : [1]).forEach(function (b) {
            ...
            var d = b.horiz,
              ...
              k = Math.min(
                h.dataMin,
                l ? h.min : b.toValue(b.toPixels(h.min) - b.minPixelPadding)
              ),
              l = Math.max(
                h.dataMax,
                l ? h.max : b.toValue(b.toPixels(h.max) + b.minPixelPadding)
              ),
              n = k - f;
            0 < n && ((m += n), (f = k));
            n = m - l;
      ...
      setState: function (a, c) {
        ...
        if (
          ...
          if (this.graphic)
            k && this.graphic.removeClass("highcharts-point-" + k),
              ...
              x.styledMode ||
                ...
                g.options.inactiveOtherPoints &&
                  ...
                  this.connector &&
                    this.connector.animate({ opacity: E.opacity }, F)),
                this.graphic.animate(E, F)),
              y &&
                this.graphic.animate(
                  y,
                  b(x.options.chart.animation, n.animation, m.animation)
                ),
              w && w.hide();
          else {
            if (a && n) {
            ...
            w &&
              (w[a && x.isInsidePlot(d, e, x.inverted) ? "show" : "hide"](),
              (w.element.point = this));
          }
          (a = h.halo) && a.size
            ? (B ||
                (g.halo = B =
                  x.renderer.path().add((this.graphic || w).parentGroup)),
              B.show()[c ? "animate" : "attr"]({ d: this.haloPath(a.size) }),
              B.attr({
                class:
              ...
              x.styledMode ||
                B.attr(
                  t(
                    { fill: this.color || g.color, "fill-opacity": a.opacity },
                    a.attributes
                  )
                ))
            : B &&
