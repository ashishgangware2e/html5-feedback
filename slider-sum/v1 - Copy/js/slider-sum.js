$("document").ready(function(){
	...
	for(var i = 0;i<slide1;i++){
		...
		ele = ele + "<div class=\"row statementArea\"><div class=\"statementBlock\">".concat(statementStrArr[i], "</div><div class=\"slider\" id=\"sliderbars_").concat(i, "\" data-color=").concat(color[i], " data-index=").concat(i, "  data-fill=\"0\" data-blank=\"0\"></div></div>");
